...
$conn = new msqli ("localhost:8889","root","root","eshop");
      ...
      <div id="colonna1" class="col-xs-12 col-sm-12 colonna">
        <div class="row">
          <div class="col-xs-12 colonna">
            <div class="page-header"><h3>Cosa pensi dei nostri prodotti?</h3></div>
          </div>
        </div>
          ...
          <br>
        Commento:<br><textarea name="commento"></textarea>
        ...
        <input type="submit" value="Aggiungi commento"/>
          ...
          <iframe src="/commento_form.php" width="50%" height="50%"></iframe>
