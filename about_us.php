...
<nav class="navbar navbar-default navbar-fixed-top" style="background-color: #eaefe1">
  ...
  <!-- /.navbar-collapse -->
	...
	<div class="container">
	<div class="row">
	<div class="text-center" style="padding-top:20%;"><h1 id="titoli" class="text-black sanelma fontx8 no-margin">ABOUT US</h1></div>
	
         <h4 style="font-style: oblique;" class="text-center">Scopri di più su Bio Matec...</h4>
        <hr>
     
        <br>
	<div class="text-center"><h2 style="text-align:centre;">La nostra azienda</h2></div>
     
      
      
        <br>
        <div class="col-sm-8 col-xs-12"><img src="img/about_us2.jpg" id="about_us"></div>
    
        <div style="padding-top:3.5%;" class="col-sm-4 col-xs-12">
            
         <button class="showr">+</button>
            <button class="hidr">-</button>
            <br>
            <br>
        ...
        <p id="azienda" style="display: none">Bio Matec è un’azienda giovane e dinamica nata dall’interesse per la tecnologia e il rispetto dell’ambiente. Viene fondata nel 2003 da Giulia Zuccaro e Ilaria Del Boca, due giovani laureande in Chimica. <br><br>
            La nostra linea di prodotti cosmetici è interamente realizzata in Italia, e più precisamente in Piemonte, tra le Langhe, il Roero e il Monferrato, terre collinari ricoperte di vigneti che, grazie alla loro inestimabile bellezza sono diventate patrimonio UNESCO.
            <br><br>
...
<br>
	...
	<div class="text-center"><h2 style="text-align:centre;">I nostri ricercatori</h2></div>
        <br>
         <div class="col-sm-8 col-xs-12"><img src="img/about_us1.jpg" id="about_us"></div>
        ...
        <div style="padding-top:3.5%;" class="col-sm-4 col-xs-12">
         ...
         <button class="shows">+</button>
            <button class="hids">-</button>
            <br>
            <br>
        ...
        <p id="ricercatori" style="display: none">Confidiamo nel nostro percorso, nel nostro spirito di squadra giovane e dinamica fondato su una sinergia di idee, energie, professionalità diverse e complementari. Crediamo nello sviluppo di una cosmesi etica oltre che a basso impatto ambientale; nel mondo dell’ecobio a cui ci siamo avvicinati per interessi personali e di studio, da cui siamo nati e dove siamo felici di operare. 
            <br><br>
          Siamo un’officina di idee e formulazioni di prodotti biologici, innovativi, legati al Piemonte, ma grazie al nostro e-commerce è possibile fare acquisti nel nostro negozio online da qualsiasi provenienza geografica. Tutte le richieste, dal consiglio per il prodotto migliore per i propri capelli a eventuali problemi con i prodotti possono essere esaudite tramite mail o contatti Facebook e Twitter.
...
$( ".shows" ).click(function() {
  $( "#ricercatori" ).show( "slow" );
});

 
$( ".hids" ).click(function() {
  $( "#ricercatori" ).hide( 1000 );
});
</script>
...
<br>
<br>
<h3 style="text-align:center;">Staff BIO MATEC</h3>
<!-- Tabella -->
 <div class="table-responsive" style="width:90%; margin:5%;" >
<table class="table">
  <thead>
    <tr>
      <th>N°</th>
  ...
  <tbody>
    <tr>
      ...
      <td>Dir. Commerciale</td>
        <td>giulia.zuccaro@biomatec.com</td>
        <td>011-9945678</td>
    </tr>
    <tr>
      <td>2</td>
      <td>Ilaria</td>
      <td>Del Boca</td>
      <td>Resp. Amministrativo</td>
        <td>ilaria.delboca@biomatec.com</td>
        <td>011-671233</td>
    </tr>
    <tr>
      <td>3</td>
      ...
      <td>Verdi</td>
      <td>Resp. Qualità</td>
        <td>sandro.verdi@biomatec.com</td>
        <td>011-167289</td>
    </tr>
  </tbody>
</table>
