...
$query_prodotto =  "SELECT * FROM prodotti where idprodotto=$idprodotto";
            ...
            <?php
              ...
              if ($riga = $risultato->fetch_array()) {
                    ...
                    $immagine=$riga["immagine"];
                     ...
                     echo "<div class='col-xs-12' style='margin-top:5%; margin-bottom:5%;'>";
          echo "<article class='schedavg' data-src='http://localhost:8888/biomatec/img/".$immagine."'>";
			
          echo "<img style='width:60%;' data-src='http://localhost:8888/biomatec/img/".$immagine."'/>";
