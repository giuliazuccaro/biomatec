...
include "config.php";
 ...
 $query_ricerca = "SELECT * FROM prodotti WHERE nome LIKE '%".$_REQUEST["ricerca"]."%'"; 
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbar-example">
      ...
      <li><a href="corpo.php">Corpo</a></li>
	   ...
	   <li><a href="#">Speciale Ottobre</a></li>
      ...
      <div id="colonna1" class="col-xs-12 col-sm-12 colonna">
        <div class="row">
          <div class="col-xs-12 colonna">
            <div class="page-header"><h3>Ecco i prodotti che cercavi:</h3></div>
          </div>
        </div>
            <?php
              ...
              while ($riga = $risultato->fetch_array()) {
                    ...
                    $nome = $riga["nome"];  $descrizione=substr($riga["descrizione"],0,100)."...";
                    $prezzo=$riga["prezzo"];
          ...
          echo "<img style='width:40%;' data-src='http://localhost:8888/biomatec/img/".$immagine."'/>";
            ...
            echo "<h5><a href='prodotto.php? id=$id'>$nome</a></h5>";
